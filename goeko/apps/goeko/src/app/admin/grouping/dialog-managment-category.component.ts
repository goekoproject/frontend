...
import { Category, ClassificationsService, NewUpdateCategory, Translations } from '@goeko/store'
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, ButtonModule, GoInputModule, TranslateModule],
