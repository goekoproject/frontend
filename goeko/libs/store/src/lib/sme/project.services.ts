...
import { Observable, map, mergeMap, from, ObservableInput, filter, reduce } from 'rxjs';
...
export class ProjectService {
	...
	getProjectById(id: string): Observable<any> {
		return this._http.get<any>(`${this.configuration.endpoint}/v1/recommendation/projects/smes/${id}`);
	}

	createProject(body: SmeCreateRecomendationRequest): Observable<any> {
		return this._http.post<any>(`${this.configuration.endpoint}/v1/recommendation/projects/smes`, body);
	}
	...
	updateProject(id: string, body: SmeSaveRecomendationRequest): Observable<any> {
		return this._http.put<any>(`${this.configuration.endpoint}/v1/recommendation/projects/smes/${id}`, body);
	}
