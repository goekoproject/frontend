import { Component, ComponentRef, ElementRef, OnDestroy, ViewChild, ViewContainerRef, effect } from '@angular/core'
...
export class SideDialogComponent implements OnDestroy {
  ...
  private _createComponent() {
    ...
    this.component = this.componenteRef.createComponent(this.dialog().component, {
